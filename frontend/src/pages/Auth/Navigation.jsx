...
const Navigation = () => {
    ...
    return (
        ...
        } xl:flex lg:flex md:hidden sm:hidde n flex-col justify-between p-4 text-white bg-[#000] w-[4%] hover:w-[15%] h-[100vh]  fixed `}
                        ...
                        ${!userInfo.isAdmin ? '-top-20' : '-top-80'}`}>
                            {userInfo.isAdmin && (
                                <>
                                    ...
                                    <li>
                                        <Link to='/admin/productlist' className="block px-4 py-2 hover:bg-gray-100">Create Product</Link>
                                    </li>
                                    <li>
